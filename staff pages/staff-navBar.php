    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navmenu">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a href="https://mi-linux.wlv.ac.uk/~2351103/staff-homepage.php" class="nav-link">HOME</a></li>
                <li class="nav-item"><a href="https://mi-linux.wlv.ac.uk/~2351103/add-event.php" class="nav-link">EVENT</a></li>
                <li class="nav-item"><a class="nav-link">ATTENDANCE</a></li>
                <li class="nav-item"><a href="logout.php" style="color: black;" class="nav-link">Log out</a></li>
            </ul>
